...
export default function ContactPage() {
  ...
  return (
    <main id="main-content" className="flex-1 bg-page-bg">
      ...
      <section className="bg-page-bg section-y-bottom"><Container><div className="rounded-hero bg-brand-dark p-8 text-white sm:p-12"><p className="text-xs font-bold uppercase tracking-[0.14em] text-white/75">Request service</p><h2 className="mt-5 max-w-5xl text-balance text-[clamp(2.25rem,5vw,3.75rem)] font-semibold leading-[1.05] tracking-[-0.03em]">Tell us what you’re noticing.</h2><p className="mt-6 max-w-2xl text-lg leading-8 text-white/65">Choose the closest service, share the issue and location, and provide preferred timing. Online delivery remains unconnected, so the flow will not claim Apex received the request.</p><BookingLink variant="invert" className="mt-9">Prepare a request</BookingLink></div></Container></section>
    </main>
  );
}
