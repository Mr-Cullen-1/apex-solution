...
export default function BrandsPage() {
  return (
    <main id="main-content" className="flex-1 bg-page-bg">
      ...
      <section className="bg-page-bg section-y-bottom"><Container><div className="grid gap-10 rounded-hero border border-steel bg-surface p-8 shadow-soft sm:p-12 lg:grid-cols-[1fr_0.7fr] lg:items-end"><div><p className="eyebrow">A practical next step</p><h2 className="mt-5 max-w-4xl text-balance text-[clamp(2rem,5vw,3.5rem)] font-semibold leading-[1.05] tracking-[-0.03em] text-navy">Don’t see your brand?</h2><p className="mt-6 max-w-2xl text-lg leading-8 text-slate">Contact us—we may still be able to help. A brand not shown here does not automatically prevent a service request.</p></div><div className="flex flex-col gap-3 lg:items-start"><BookingLink variant="primary" /><ButtonLink href="/contact" variant="secondary">Contact us</ButtonLink></div></div></Container></section>
    </main>
  );
}
