...
export default function AboutPage() {
  return (
    <main id="main-content" className="flex-1">
      ...
      <section className="bg-warm-white py-16 sm:py-24"><Container><div className="max-w-5xl"><p className="eyebrow">About Apex Home Services</p><h1 className="mt-5 text-balance text-[clamp(4rem,9vw,8rem)] font-semibold leading-[0.84] tracking-[-0.075em] text-navy">Reliable home service starts with clarity.</h1><p className="mt-8 max-w-2xl text-xl leading-8 text-slate">{company.tagline} Apex brings multiple home-service categories into one considered, understandable experience.</p><BookingLink className="mt-9">Request service</BookingLink></div></Container></section>
