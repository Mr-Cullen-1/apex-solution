...
export async function generateMetadata({ params }: ServicePageProps): Promise<Metadata> {
  ...
  if (!service) return {};
  return { title: service.seo.title, description: service.seo.description, alternates: { canonical: service.href }, openGraph: { ...sharedOpenGraph, title: service.seo.title, description: service.seo.description, url: service.href }, robots: { index: true, follow: true } };
}
