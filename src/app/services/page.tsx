      ...
      <section className="bg-page-bg pb-16 pt-6 sm:pb-24 sm:pt-8">
        <Container>
          <div className="grid gap-12 overflow-hidden rounded-hero border border-steel bg-surface p-8 shadow-hero sm:p-12 lg:grid-cols-[1.08fr_0.92fr] lg:items-center lg:p-0">
            ...
            <div className="relative min-h-72 overflow-hidden lg:min-h-[28rem]"><Image src={media.realHeatingUnit.src} alt={media.realHeatingUnit.alt} fill priority sizes="(min-width:1024px) 42vw, 100vw" className="object-cover" style={{ objectPosition: media.realHeatingUnit.focalPoint }} /></div>
          </div>
        </Container>
      </section>
