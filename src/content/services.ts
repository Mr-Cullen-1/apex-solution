...
const acRepair = service({
  ...
  brandGroupIds: ["hvac"], mediaId: "northeastHvac", seo: { title: "AC Repair Services", description: "Explore AC repair service from Apex Home Support, including common cooling concerns, what to expect, related services, and how to request an inspection." }, status: "published",
});
...
const acInstallation = service({
  ...
  brandGroupIds: ["hvac"], mediaId: "northeastHvac", seo: { title: "AC Installation Services", description: "Learn how Apex Home Support approaches residential AC installation planning, equipment discussions, and next-step service requests." }, status: "published",
});
...
const acMaintenance = service({
  ...
  brandGroupIds: ["hvac"], mediaId: "serviceDetail", seo: { title: "AC Maintenance Services", description: "Review residential AC maintenance from Apex Home Support, including common reasons to schedule seasonal system attention." }, status: "published",
});
...
const furnaceRepair = service({
  ...
  brandGroupIds: ["hvac"], mediaId: "serviceDetail", seo: { title: "Furnace Repair Services", description: "Explore furnace repair service from Apex Home Support, including common heating concerns and what a service visit may involve." }, status: "published",
});
...
const heatPumps = service({
  ...
  brandGroupIds: ["hvac"], mediaId: "northeastHvac", seo: { title: "Heat Pump Services", description: "Explore residential heat-pump service and equipment considerations with Apex Home Support." }, status: "published",
});
...
const heatingMaintenance = service({
  ...
  brandGroupIds: ["hvac"], mediaId: "serviceDetail", seo: { title: "Heating Maintenance Services", description: "Learn about seasonal residential heating maintenance and how to request a system review from Apex Home Support." }, status: "published",
});
...
export const primaryServices: readonly ServiceCategory[] = [
  {
    ...
    seo: { title: "Appliance Repair Services", description: "Explore appliance repair service from Apex Home Support, supported brand categories, common service situations, and how to request an inspection." },
  },
  {
  ...
  },
  {
    ...
    seo: { title: "Residential Heating Services", description: "Browse furnace repair, heat-pump, and heating-maintenance services from Apex Home Support." },
  },
  {
    ...
    seo: { title: "Residential Plumbing Services", description: "Browse water-heater, drain-cleaning, and leak-detection services from Apex Home Support." },
  },
  {
    ...
    seo: { title: "Indoor Air Quality Services", description: "Explore indoor air quality and airflow service from Apex Home Support, including common comfort concerns and next steps." },
  },
];
