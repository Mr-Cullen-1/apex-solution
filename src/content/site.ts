...
export const faqs: FAQ[] = [
  ...
  { id: "service-area", question: "Does Apex Home Support serve my area?", answer: "Apex Home Support covers confirmed counties across New York, New Jersey, Connecticut, Massachusetts, and Rhode Island. Exact ZIP-level availability should be confirmed when you book." },
